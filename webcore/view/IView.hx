...
interface IView {
	...
	**/
	...
	final nativeView: View.NativeView;
	...
	**/
	private function onPointerDown(event: PointerEvent): Bool;
	...
	**/
	private function onPointerMove(event: PointerEvent): Bool;
	...
	**/
	private function onPointerUp(event: PointerEvent): Bool;
	...
	**/
	private function onPointerCancel(event: PointerEvent): Bool;
	...
	**/
	private function onWheel(event: WheelEvent): Bool;
	...
	**/
	private function onKeyDown(event: KeyboardEvent, hasFocus: Bool): Bool;
	...
	/**
		...
		`hasFocus` is true if our view has input focus for the event. For `hasFocus` to be correct the canvas needs to be focusable. This requires setting the `tabIndex` attribute on the canvas
	**/
	private function onKeyUp(event: KeyboardEvent, hasFocus: Bool): Bool;
