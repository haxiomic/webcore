...
import webcore.typedarray.ArrayBufferView.ArrayBufferViewBase;
import webcore.typedarray.ArrayBufferView.ArrayLike;
import webcore.typedarray.ArrayBufferView.ArrayBufferViewImplIterator;
...
@:forward
#if !macro
@:build(webcore.typedarray.macro.BuildArrayBufferView.build(ArrayType))
#end
