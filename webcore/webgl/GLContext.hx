...
import webcore.typedarray.ArrayBufferView;
...
typedef GLArrayBuffer       = webcore.typedarray.ArrayBuffer;
typedef GLArrayBufferView   = webcore.typedarray.ArrayBufferView;
typedef GLInt8Array         = webcore.typedarray.Int8Array;
typedef GLUint8Array        = webcore.typedarray.Uint8Array;
typedef GLUint8ClampedArray = webcore.typedarray.Uint8ClampedArray;
typedef GLInt16Array        = webcore.typedarray.Int16Array;
typedef GLUint16Array       = webcore.typedarray.Uint16Array;
typedef GLInt32Array        = webcore.typedarray.Int32Array;
typedef GLUint32Array       = webcore.typedarray.Uint32Array;
typedef GLFloat32Array      = webcore.typedarray.Float32Array;
typedef GLFloat64Array      = webcore.typedarray.Float64Array;

#if js
abstract TexImageSource(Dynamic)
	from webcore.image.Image        to webcore.image.Image
...
#else
abstract TexImageSource(webcore.image.Image)
	from webcore.image.Image to webcore.image.Image
#end
{
...
private typedef InternalGLContext = 
	...
	#elseif cpp
		webcore.webgl.native.GLContext;
	#else
		Dynamic;
	#end
...
#if debug
@:build(webcore.webgl.GLContextDebug.addErrorChecking())
#end
