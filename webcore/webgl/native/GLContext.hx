	...
	**/
	...
	public function texImage2DImageSource(target:TextureTarget, level:GLint, internalformat:PixelFormat, format:PixelFormat, type:PixelDataType, source:TexImageSource) {
		...
		@:privateAccess {
			...
			var imageSource: webcore.image.Image = source;
			...
			var dataType = switch type {
				case FLOAT: webcore.image.Image.PixelDataType.FLOAT;
				case UNSIGNED_BYTE: webcore.image.Image.PixelDataType.UNSIGNED_BYTE;
				default: null;
			}
