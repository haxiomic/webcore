...
extern class NativeAudioNode {
	...
	var lock: Star<webcore.audio.native.MiniAudio.Mutex>;
	...
	static function create(maContext: Star<webcore.audio.native.MiniAudio.Context>): Star<NativeAudioNode>;
...
extern class NativeAudioNodeList {
	...
	static function create(maContext: Star<webcore.audio.native.MiniAudio.Context>): Star<NativeAudioNodeList>;
