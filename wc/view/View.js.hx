	...
	**/
	...
	public function new() {
		...
		function addPointerEventListeners() {
			// Pointer Input
			function executePointerMethodFromMouseEvent(mouseEvent: js.html.MouseEvent, pointerMethod: (wc.event.PointerEvent) -> Bool) {
				// trackpad force
			...
			function executePointerMethodFromTouchEvent(touchEvent: js.html.TouchEvent, pointerMethod: (wc.event.PointerEvent) -> Bool) {
				var buttonStates: {
					button: Int,
					buttons: Int,
