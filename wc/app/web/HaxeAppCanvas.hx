...
class HaxeAppCanvas {
	...
	public final appInstance: HaxeAppInterface;
	public final canvas: CanvasElement;

	final gl: RenderingContext;
	var requestAnimationFrameHandle: Int = -1;

	public function new(appInstance: HaxeAppInterface, ?canvas: CanvasElement, ?webglContextAttributes: GLContextAttributes) {
		...
		canvas.addEventListener('webglcontextlost', () -> {
			appInstance.onGraphicsContextLost();
	...
	public function onVisibilityChange() {
